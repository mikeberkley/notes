-- Remove content='' so FTS5 stores its own copy of row data.
-- With content='', UNINDEXED columns (smo_id, user_id, layer) return NULL,
-- breaking the JOIN used by the search query.
